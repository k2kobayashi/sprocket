...
Usage: run_sprocket_cycleRNN.py [-h] [-1] [-2] [-3] [-4] [-5] [-6] SOURCE TARGET
...
Options:
    ...
    -4, --step4  Execute step4 (Preparation of joint feature vector)
    -5, --step5  Execute step5 (Train neural network)
    -6, --step6  Execute step6 (Conversion based on the trained models)
